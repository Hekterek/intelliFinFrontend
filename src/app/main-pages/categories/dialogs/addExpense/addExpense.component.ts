...
import { AccountPickerComponent } from 'src/app/main-pages/accounts/dialogs/accountPicker/accountPicker.component';
import { EditDescriptionComponent } from 'src/app/main-pages/accounts/dialogs/editDescription/editDescription.component';
import { NotEnoughMoneyDialogComponent } from 'src/app/main-pages/accounts/dialogs/notEnoughMoneyDialog/notEnoughMoneyDialog.component';
...
export class AddExpenseComponent implements OnInit {
  ...
  constructor(
    @Inject(MAT_DIALOG_DATA) protected _data: categoryDTO,
    private fb: FormBuilder,
    private dialog: MatDialog,
    private accountService: AccountService,
    private transferDialogRef: MatDialogRef<AddExpenseComponent>
  ) {}
  ...
  loadFromAccount(): void {
    this.accountService
      .getAllAccounts()
      .pipe(
        map((account) =>
          account.filter((account) => account.mainAccount === true)
        )
      )
      .subscribe((account) => {
